...
const Projects = () => {
  return (
    <section className='md:my-8 my-12'>
      <div className='container md:max-w-[768px] mx-auto sm:px-16 px-4 py-4 z-10 flex flex-col items-center'>
        ...
        <ul className='mt-12'>
          {projectsArray.map((project: Project) => (
            <li
              className='pt-5 pb-6 not-last:border-b-1 border-neutral-200 dark:border-neutral-700'
              key={project.title}
            >
